...
export type Database = {
  ...
  guest: {
    ...
    Functions: {
      ...
      close_channel: { Args: { p_channel_id: string }; Returns: undefined };
      create_channel: {
        Args: {
      ...
      current_member_id: { Args: { p_channel_id: string }; Returns: string };
      delete_message: {
      ...
      expire_due_channels: {
        Args: { p_empty_grace_minutes?: number };
        Returns: {
          channel_id: string;
      ...
      generate_channel_code: { Args: never; Returns: string };
      ...
      requester_is_anonymous: { Args: never; Returns: boolean };
      resolve_requester_display_name: {
        Args: { p_requested_display_name?: string };
        Returns: string;
      };
